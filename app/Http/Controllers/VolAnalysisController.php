...
class VolAnalysisController extends Controller
{
     ...
     */
     ...
     public function vol_analsisExpo(Request $request){
       ...
       ->select('Client.DCLink','Account','Name','cCode','ucSASerialNo','cDescription','ucSASerialNo','cLocation','_smtblServiceAsset.AutoIdx')            
       ->get();  
    ...
    public function summary(Request $request){
        ...
        if($request->ajax()){ 
            ...
            $individual_asset=DB::table('_smtblServiceAsset')
            ->select('cDescription','cCode','ucSASerialNo','cLocation','MonPMR','MonCMR','ColPMR','ColCMR','ScnCMR','ScnPMR','A3MPMR','A3MCMR','A3CPMR','A3CCMR')
            ...
            ->where('_smtblServiceAsset.iCustomerId',$customer_id) 
            ->where('_smtblServiceAsset.cCode', 'NOT LIKE', 'CON%')  
        ...
        return Excel::download(new SummaryExport($today,$summary_cons,$individual_asset,$rental,$total_a3c,$total_a3m,$total_scn,$total_mon,$total_col,$individual_asset_totals,$details ),'CustomerSummarySheet.xlsx');
        // return Excel::download(new SummaryExport($today,$summary,$summarymon,$individual_asset,$individual_asset_totals,$rental,$col_total,$mon_total,$scn_total,$a3c_total,$a3m_total),'CustomerSummarySheet.xlsx');
