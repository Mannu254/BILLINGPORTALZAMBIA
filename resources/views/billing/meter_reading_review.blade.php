...
<form action="{{action('BillingExecutiveController@billing_review')}}" method="get">
{{ csrf_field() }}
...
<tr style="font-family:apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;"><th colspan="6"></th><th colspan="3">MONO  <div id="total_mono" class="total_mono" style="float: right;color:yellow;" ></div></th><th colspan="3">COLOR <div id="total_color" class="total_color" style="float: right;color:yellow;" ></div></th><th colspan="2"></th></tr>
<tr>
    ...
    {{-- <th class="fixed" scope="col">Code</th> --}}
    <th class="fixed"scope="col" style="width:50px;">Description</th>
    <th class="fixed" scope="col">SerialNo</th>
    <th class="fixed" scope="col">Billing Asset</th>
    <th scope="col">ReadingDate</th>
    {{-- <th>AssetID</th> --}}
    <th scope="col">PMR</th>
    <th scope="col">CMR</th>
    <th scope="col">Copies </th>
    {{-- <th scope="col">Copies Exl </th> --}}
    <th scope="col">PMR</th>
    <th scope="col">CMR</th>
    <th scope="col">Copies</th>
    {{-- <th scope="col">Copies Exl </th> --}}
    ...
    <td>{{ $machine->ucSASerialNo}}</td>
      ...
      <td> <input type="text" name="ucSABillingAsset[]" readonly size="8" value="{{ $machine->cCode }}"></td>      
      @else
      <td> <input type="text" name="ucSABillingAsset[]" readonly size="15" value="{{ $machine->ucSABillingAsset }}"></td>      
      @endif      
      
    <td>{{ $machine->ReadingDate}}<input type="text" hidden  name="DCLink[]" readonly size="7" value="{{ $machine->DCLink }}"><input type="text" class="asset_id" hidden name="asset_id[]" readonly size="6" value="{{ $machine->AutoIdx }}"></td>
    ...
    {{-- <td><input type="text" class="copies_exl" style="font-weight:600; color:black;"  readonly value="{{$machine->copies_mono ?? 0}}"  name="copies_exl[]" id="copies_exl"  size="6"></td> --}}
    ...
    {{-- <td><input type="text" class="copies_cxl" style="font-weight:600; color:black;"  readonly value="{{$machine->copies_col ?? ''}}" name="copies_cxl[]" id="copies_cxl"  size="6"></td> --}}
    {{-- <td><input type="text" class="a3_mono_pmr" onkeyup="format(this)" style="font-weight:400; color:black;" value="{{number_format($machine->a3_mono_pmr)}}" required  name="a3_mono_pmr[]" id="a3_mono_pmr"  size="6"></td> --}}
    {{-- <td><input type="text" class="a3_mono_cmr" onkeyup="format(this)" style="font-weight:400; color:black;" value="{{number_format($machine->A3MCMR)}}" required  name="a3_mono_cmr[]" id="a3_mono_cmr"  size="6"></td> --}}
    {{-- <td><input type="text" class="a3_color_pmr" onkeyup="format(this)" style="font-weight:400; color:black;" value="{{number_format($machine->a3_color_pmr)}}" required  name="a3_color_pmr[]" id="a3_color_pmr"  size="6"></td> --}}
    {{-- <td><input type="text" class="a3_color_cmr" onkeyup="format(this)" style="font-weight:400; color:black;" value="{{number_format($machine->A3CCMR)}}" required  name="a3_color_cmr[]" id="a3_color_cmr"  size="6"></td> --}}
    {{-- <td><input type="text" class="scn_pmr"  style="font-weight:400; color:black;"  required value="{{number_format($machine->scan_pmr ?? '0')}}" name="scn_pmr[]" id="scan_pmr"  size="6"></td> --}}
    {{-- <td><input type="text" class="scn_cmr" onkeyup="format(this)" style="font-weight:400; color:black;" value="{{number_format($machine->ScnCMR ?? '0')}}" required  name="scn_cmr[]" id="scn_cmr"  size="6"></td> --}}
    <td><input id="validation" readonly class="validation" name="validation[]"></td>
...
var grandTotalCol = 0;
  ...
  {{-- validating mono_cmr reading  --}}
    ...
    var timeout;
    var delay = 2000; 
    $(".color_cmr, .mono_cmr , .mono_pmr,.color_pmr").keyup(function() {
...
<script>
  $(document).ready(function() {
  $(".mono_cmr, .mono_pmr").keyup(function() {
    var grandTotalMon = 0;
