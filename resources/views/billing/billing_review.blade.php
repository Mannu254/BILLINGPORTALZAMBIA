...
{{-- 
    ...
    <td><input type="text" class="min_color_vol" style="font-weight:400; color:black;" value="{{ number_format($data->min_color_vol)}}" readonly required name="min_color_vol[]" id="min_color_vol"  size="7"></td>
