...
input[type=text] {
 color: black; 
  ...
  <div class="card">
    ...
    <span class="input-group-text" id="basic-addon1">Export Assets</span>
    </div>
    ...
    <div class="position-fixed container-fluid" style="margin-top: -30px; margin-left:700px;">
     <form action="{{action('SMController@update_asset')}}" method="POST" enctype="multipart/form-data">
      {{csrf_field()}}
    <div class="input-group col-md-5" >
      <div class="input-group-prepend">
      <span class="input-group-text" id="basic-addon1">Update Assets</span>
      </div>
      <input type="file" required id="file" name="file" required class="form-control">
...
<div class="card ">
    ...
    <input type="" class="form-control sdate" style="color:black" aria-label="Small" id="datepicker2" name="sdate" >
    </div>
    <div class="input-group input-group-sm col-md-6 mb-4">
    <div class="input-group-prepend">
...
<script> 
 ...
 $('#export').click(function() {    
   ...
   if (con_asset.length == 0 ) { 
     alert('You have not Searched any Code to Update!!!')
     exit();
   }
...
success: function (response) {
   var link = document.createElement('a');
       ...
       link.download = `CustomerAssets.xlsx`;
       link.click();
